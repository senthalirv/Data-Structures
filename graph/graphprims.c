...
// Insert an edge
void insertEdge(int graph[V][V], int u, int v, int weight)
{
    graph[u][v] = weight;
...
// Delete an edge
void deleteEdge(int graph[V][V], int u, int v)
{
    graph[u][v] = 0;
...
int main()
{
    ...
    // Insert edge between vertex 0 and 2 with weight 4
    insertEdge(graph, 0, 2, 4);

    // Delete edge between vertex 1 and 3
